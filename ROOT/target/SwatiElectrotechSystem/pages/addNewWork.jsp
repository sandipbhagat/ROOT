			...
			<div class="12u">
				...
				<section class="box highlight">
					...
					<fieldset  data-ng-repeat="supplier in suppliers">
				      ...
				      <button class="remove"  ng-if="supplier.id" ng-click="removeSuplierChoice($index,supplier.id)">-</button>
				      <button class="add"  ng-if="!supplier.id" >+</button>
				      <button class="remove"  ng-if="!supplier.id" ng-click="removeSuplier($index)">-</button>
				   </fieldset>
				   <button class="addfields" ng-click="addNewSuplierChoice()">Add field</button>
				   <button class="addfields" ng-click="saveAllSupliers(suppliers)">Save All</button>

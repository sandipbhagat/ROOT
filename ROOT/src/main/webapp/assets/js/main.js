				   ...
				   $scope.submitNewForm = function(selectedTender) {
					   ...
					   var data = $.param({
						   ...
						   "tenderSubmitted": (typeof($scope.selectedTender.tenderSubmitted)==='undefined') ? false : selectedTender.tenderSubmitted,
						    ...
						    "addressOfCustomer" : (typeof($scope.selectedTender.addressOfCustomer)==='undefined') ? null : selectedTender.addressOfCustomer,
						    "tenderNumber" : (typeof($scope.selectedTender.tenderNumber)==='undefined') ? null : selectedTender.tenderNumber,
						    "nameOfContactPerson" : (typeof($scope.selectedTender.nameOfContactPerson)==='undefined') ? null : selectedTender.nameOfContactPerson,
						    "numberOfContactPerson" : (typeof($scope.selectedTender.numberOfContactPerson)==='undefined') ? null : selectedTender.numberOfContactPerson,
						    "preQualificationCriteria" : (typeof($scope.selectedTender.preQualificationCriteria)==='undefined') ? null : selectedTender.preQualificationCriteria,
						    ...
						    "tenderFee" : (typeof($scope.selectedTender.tenderFee)==='undefined') ? null : selectedTender.tenderFee,
						    ...
						    "tenderSubmission" : (typeof($scope.selectedTender.tenderSubmission)==='undefined') ? null : selectedTender.tenderSubmission,
						    "paymentTerms" : (typeof($scope.selectedTender.paymentTerms)==='undefined') ? null : selectedTender.paymentTerms,
						    "offerValidity":(typeof($scope.selectedTender.offerValidity)==='undefined') ? new Date(0) : formatDate(selectedTender.offerValidity),
						    "guaranteePeriod" : (typeof($scope.selectedTender.guaranteePeriod)==='undefined') ? null : selectedTender.guaranteePeriod,
						    "deliveryPeriod" : (typeof($scope.selectedTender.deliveryPeriod)==='undefined') ? null : selectedTender.deliveryPeriod,
						    "performanceGuarantee" : (typeof($scope.selectedTender.performanceGuarantee)==='undefined') ? null : selectedTender.performanceGuarantee,
						    "specialTermsAndCond" : (typeof($scope.selectedTender.specialTermsAndCond)==='undefined') ? null : selectedTender.specialTermsAndCond,
						    "specialDocsToAttach" : (typeof($scope.selectedTender.specialDocsToAttach)==='undefined') ? null : selectedTender.specialDocsToAttach,
						    "sheetPreparedBy" : (typeof($scope.selectedTender.sheetPreparedBy)==='undefined') ? null : selectedTender.sheetPreparedBy
